        ...
        <el-dialog :title="titleName"  :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="70px">
                ...
                <el-form-item label="所属科室">
                  <el-input v-model="form.typeName" readOnly class="input"></el-input>
                </el-form-item>
        ...
        methods: {
            ...
            async handleEdit(index, row) {
                ...
                if(user.data.statusCode==200){
                    ...
                    this.form.typeName=user.data.data.typeName;
            ...
            async add(){
               ...
               this.getRole();
                ...
                const org = await this.$http.get(baseURL_.lyjUrl+'/organization/getById',{ 
                    params: {'id':this.org_id}
                });
               this.form.typeName=org.data.data.name;
