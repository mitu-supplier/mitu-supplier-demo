    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table  row-key="id" lazy :data="tableData" :load="load" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" border id="table_id" ref="multipleTable"  @selection-change="handleSelectionChange">
                ...
                <el-table-column label="操作" width="" align="center" v-if="button_role&&(button_role.delete||button_role.edit||button_role.look||button_role.org_user_look)">
                    <template slot-scope="scope">
                        
                        <el-button type="text" icon="el-icon-document"  v-if="button_role&&button_role.org_user_look" @click="showUser(scope.$index, scope.row)">查看人员</el-button>
...
<script>
    ...
    export default {
        ...
        data() {
             ...
             var phone = (rule, value, callback) => {//包含小数的数字
